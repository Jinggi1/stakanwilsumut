        ...
        <div class="row">
          <div class="col-md-8">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <?php echo form_open('client/password/change'); ?>
                <div class="card-body">
                <input type="hidden" id="id_klien" name="id_klien" value="<?=@$_SESSION['id_klien'];?>">
                <input type="hidden" id="datapassword" name="datapassword" value="<?=@$_SESSION['password_klien'];?>">
