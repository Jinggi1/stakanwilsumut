...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    ...
    <div class="card-body">
      <p class="login-box-msg">Login Client</p>

      <form method="post" action="<?php echo base_url('login_client/auth');?>">
        <div class="input-group mb-3">
          <input type="text" name="username_klien" id="username" class="form-control" placeholder="Username" required>
        ...
        <div class="input-group mb-3">
          <input type="password" name="password_klien" id="password" class="form-control" placeholder="Password" required>
          <div class="input-group-append">
            <div class="input-group-text">
