  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Manajemen Seksi</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <!-- END FLASH DATA -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"><button type="button" class="btn btn-block btn-primary btn-lg" data-toggle="modal" data-target="#modal-create-new-div">Create New</button></h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                      <?php 
                      if ($d->div_status == 1) {
                      echo '<button type="button" class="btn btn-block btn-success btn-sm" data-toggle="modal" data-target="#modal-nonactivation-'.$d->id_div.'">Active</button>';
                      }else{
                        echo '<button type="button" class="btn btn-block btn-danger btn-sm" data-toggle="modal" data-target="#modal-activation-'.$d->id_div.'">Non-Active</button>';
                      }; ?>
                    </td>
                    <td><button type="button" class="btn btn-block btn-warning btn-sm" data-toggle="modal" data-target="#modal-edit-div-<?php echo $d->id_div ?>">Edit</button></td>
                    <!-- modal edit user -->
                    <div class="modal fade" id="modal-edit-div-<?php echo $d->id_div ?>">
                      <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h4 class="modal-title">Edit Division <?php echo $d->div_name ?></h4>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                              <span aria-hidden="true">&times;</span>
                            </button>
                          </div>
                          <div class="modal-body">
                          <?php echo form_open('core/division/edit'); ?>  
                              <div class="card-body">
                              <input type="hidden" id="id_div" name="id_div" value="<?php echo $d->id_div ?>">
                                <div class="form-group">
                                  <label for="exampleInputDeptName">Division Name</label>
                                  <input type="text" name="div_name" value="<?php echo $d->div_name ?>" class="form-control" id="exampleInputDeptName" placeholder="Enter Division Name" required>
                                </div>
                              </div>
                          </div>
                    ...
                    <div class="modal fade" id="modal-activation-<?php echo $d->id_div ?>">
                      <div class="modal-dialog">
                        <div class="modal-content bg-success">
                          <div class="modal-header">
                            <h4 class="modal-title">Aktifkan Seksi?</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                              <span aria-hidden="true">&times;</span>
                            </button>
                          </div>
                          <div class="modal-body">
                            <p>Anda akan mengaktifkan Seksi <?php echo $d->div_name ?>?</p>
                          </div>
                          <?php echo form_open('core/division/activation'); ?>
                          <div class="modal-footer justify-content-between">
                            <input type="hidden" id="id_div" name="id_div" value="<?php echo $d->id_div ?>">
                            <input type="hidden" id="div_status" name="div_status" value="1"> 
                    ...
                    <div class="modal fade" id="modal-nonactivation-<?php echo $d->id_div ?>">
                      <div class="modal-dialog">
                        <div class="modal-content bg-danger">
                          <div class="modal-header">
                            <h4 class="modal-title">Non-Aktifkan Seksi?</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                              <span aria-hidden="true">&times;</span>
                            </button>
                          </div>
                          <div class="modal-body">
                            <p>Anda akan menon-aktifkan Seksi <?php echo $d->div_name ?>?</p>
                          </div>
                          <?php echo form_open('core/division/activation'); ?>
                          <div class="modal-footer justify-content-between">
                            <input type="hidden" id="id_div" name="id_div" value="<?php echo $d->id_div ?>">
                            <input type="hidden" id="div_status" name="div_status" value="2"> 
                            <button type="button" class="btn btn-outline-light" data-dismiss="modal">Close</button>
      ...
      <!-- modal new user -->
      <div class="modal fade" id="modal-create-new-div">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Buat Seksi Baru</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
            <?php echo form_open('core/division/add'); ?>  
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputLocName">Nama Seksi</label>
                    <input type="text" name="div_name" class="form-control" id="exampleInputDeptName" placeholder="Masukkan Nama Seksi" required>
                  </div>
                </div>
            </div>
            <div class="modal-footer justify-content-between">
