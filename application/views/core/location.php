  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Manajemen Lokasi</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <!-- END FLASH DATA -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"><button type="button" class="btn btn-block btn-primary btn-lg" data-toggle="modal" data-target="#modal-create-new-location">Create New</button></h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    <td><?php echo $no++ ?></td>
                    <td><?php echo $l->loc_name ?></td>
                    <td>
                      <?php 
                      if ($l->loc_status == 1) {
                      echo '<button type="button" class="btn btn-block btn-success btn-sm" data-toggle="modal" data-target="#modal-nonactivation-'.$l->id_loc.'">Active</button>';
                      }else{
                        echo '<button type="button" class="btn btn-block btn-danger btn-sm" data-toggle="modal" data-target="#modal-activation-'.$l->id_loc.'">Non-Active</button>';
                      }; ?>
                    </td>
                    <td><button type="button" class="btn btn-block btn-warning btn-sm" data-toggle="modal" data-target="#modal-edit-location-<?php echo $l->id_loc ?>">Edit</button></td>
                    <!-- modal edit user -->
                    <div class="modal fade" id="modal-edit-location-<?php echo $l->id_loc ?>">
                      <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h4 class="modal-title">Edit Location <?php echo $l->loc_name ?></h4>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                              <span aria-hidden="true">&times;</span>
                            </button>
                          </div>
                          <div class="modal-body">
                          <?php echo form_open('core/location/edit'); ?>  
                              <div class="card-body">
                              <input type="hidden" id="id_loc" name="id_loc" value="<?php echo $l->id_loc ?>">
                                <div class="form-group">
                                  <label for="exampleInputLocName">Location Name</label>
                                  <input type="text" name="loc_name" value="<?php echo $l->loc_name ?>" class="form-control" id="exampleInputName" placeholder="Enter Location Name" required>
                                </div>
                              </div>
                          </div>
                    ...
                    <div class="modal fade" id="modal-activation-<?php echo $l->id_loc ?>">
                      <div class="modal-dialog">
                        <div class="modal-content bg-success">
                          <div class="modal-header">
                            <h4 class="modal-title">Aktifkan Lokasi?</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                              <span aria-hidden="true">&times;</span>
                            </button>
                          </div>
                          <div class="modal-body">
                            <p>Anda akan mengaktifkan lokasi <?php echo $l->loc_name ?>?</p>
                          </div>
                          <?php echo form_open('core/location/activation'); ?>
                          <div class="modal-footer justify-content-between">
                            <input type="hidden" id="id_loc" name="id_loc" value="<?php echo $l->id_loc ?>">
                            <input type="hidden" id="loc_status" name="loc_status" value="1"> 
                    ...
                    <div class="modal fade" id="modal-nonactivation-<?php echo $l->id_loc ?>">
                      <div class="modal-dialog">
                        <div class="modal-content bg-danger">
                          <div class="modal-header">
                            <h4 class="modal-title">Non-Aktifkan Lokasi?</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                              <span aria-hidden="true">&times;</span>
                            </button>
                          </div>
                          <div class="modal-body">
                            <p>Anda akan menon-aktifkan lokasi <?php echo $l->loc_name ?>?</p>
                          </div>
                          <?php echo form_open('core/location/activation'); ?>
                          <div class="modal-footer justify-content-between">
                            <input type="hidden" id="id_loc" name="id_loc" value="<?php echo $l->id_loc ?>">
                            <input type="hidden" id="loc_status" name="loc_status" value="2"> 
                            <button type="button" class="btn btn-outline-light" data-dismiss="modal">Close</button>
      ...
      <!-- modal new user -->
      <div class="modal fade" id="modal-create-new-location">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
            <?php echo form_open('core/location/add'); ?>  
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputLocName">Nama Lokasi</label>
                    <input type="text" name="loc_name" class="form-control" id="exampleInputLocName" placeholder="Enter Location Name" required>
                  </div>
                </div>
            </div>
            <div class="modal-footer justify-content-between">
