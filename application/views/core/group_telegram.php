  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Group Telegram Setting</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item">Helpdesk</li>
              <li class="breadcrumb-item active">Group Telegram Setting</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <!-- END FLASH DATA -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"><button type="button" class="btn btn-block btn-primary btn-lg" data-toggle="modal" data-target="#modal-create-new-group">Create New</button></h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php 
                  $no = 1;
                  foreach($telegram_group as $t){ ?>
                  <tr>
                    <td><?php echo $no++ ?></td>
                    <td><?php echo $t->groupid ?></td>
                    <td><?php echo $t->group_name ?></td>
                    <td><?php echo $t->div_name ?></td>
                    <td><?php echo $t->loc_name ?></td>
                    <td><button type="button" class="btn btn-block btn-warning btn-sm" data-toggle="modal" data-target="#modal-edit-group-<?php echo $t->id_group ?>">Edit</button></td>
                  </tr>
                  <!-- modal edit group -->
                    <div class="modal fade" id="modal-edit-group-<?php echo $t->id_group ?>">
                      <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h4 class="modal-title">Edit Group <?php echo $t->group_name ?></h4>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                              <span aria-hidden="true">&times;</span>
                            </button>
                          </div>
                          <div class="modal-body">
                          <?php echo form_open('core/group_telegram/edit'); ?>
                              <div class="card-body">
                              <input type="hidden" id="id_group" name="id_group" value="<?php echo $t->id_group ?>">
                                <div class="form-group">
                                  <label for="exampleInputName">Group Name</label>
                                  <input type="text" name="group_name" value="<?php echo $t->group_name ?>" required class="form-control" id="exampleInputName" placeholder="Enter Group Name">
                                </div>
                                <div class="form-group">
                                  <label for="exampleInputName">Group ID</label>
                                  <input type="text" name="groupid" value="<?php echo $t->groupid ?>" required class="form-control" id="exampleInputName" placeholder="Enter Group Token">
                                </div>
                                <div class="form-group">
                                  <label>Division</label>
                                  <select class="form-control select2 select2-danger" name="id_div" required data-dropdown-css-class="select2-danger" style="width: 100%;">
                                    <option selected="selected" value="<?php echo $t->id_div ?>"><?php echo $t->div_name ?></option>
                                    <?php 
                                ...
                                <div class="form-group">
                                  ...
                                  <select class="form-control select2 select2-danger" name="id_loc" data-dropdown-css-class="select2-danger" style="width: 100%;">
                                    <option selected="selected" value="<?php echo $t->id_loc?>"><?php echo $t->loc_name ?></option>
                                    <?php 
                                    foreach($location as $kol)
                                      { 
                                        echo '<option value="'.$kol->id_loc.'">'.$kol->loc_name.'</option>';
                                      }
                                    ?>
                                  </select>
                                </div>
      ...
      <!-- modal new user -->
      <div class="modal fade" id="modal-create-new-group">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
              <?php echo form_open('core/group_telegram/add'); ?>
                <div class="card-body">
                <div class="form-group">
                                  <label for="exampleInputName">Group Name</label>
                                  <input type="text" name="group_name" required class="form-control" id="exampleInputName" placeholder="Enter Group Name">
                                </div>
                                <div class="form-group">
                                  <label for="exampleInputName">Group ID</label>
                                  <input type="text" name="groupid" required class="form-control" id="exampleInputName" placeholder="Enter Group Token">
                                </div>
                                <div class="form-group">
                                  <label>Division</label>
                                  <select class="form-control select2 select2-danger" name="id_div" required data-dropdown-css-class="select2-danger" style="width: 100%;">
      ...
      <div class="modal fade" id="modal-activation">
        <div class="modal-dialog">
          <div class="modal-content bg-success">
            ...
            <div class="modal-body">
              <p>Anda akan mengaktifkan divisi xxx?</p>
            </div>
            <div class="modal-footer justify-content-between">
      ...
      <div class="modal fade" id="modal-nonactivation">
        <div class="modal-dialog">
          <div class="modal-content bg-danger">
            <div class="modal-header">
              <h4 class="modal-title">Non-Aktifkan Divisi?</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
              <p>Anda akan menon-aktifkan Divisi xxx?</p>
            </div>
            <div class="modal-footer justify-content-between">
              <button type="button" class="btn btn-outline-light" data-dismiss="modal">Close</button>
              <button type="button" class="btn btn-outline-light">Non-Aktif</button>
            </div>
          </div>
          <!-- /.modal-content -->
        </div>
