              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><?php echo $k->username_klien ?></td>
                    <td><?php echo $k->email_klien ?></td>
                    <td><?php echo $k->telp_klien ?></td>
                    <td><?php echo $k->dept_name ?></td>
                    <td><?php echo $k->loc_name ?></td>
                    <td>
                      <?php 
                      if ($k->status_klien == 1) {
                      echo '<button type="button" class="btn btn-block btn-success btn-sm" data-toggle="modal" data-target="#modal-nonactivation-'.$k->id_klien.'">Active</button>';
                      }else{
                        echo '<button type="button" class="btn btn-block btn-danger btn-sm" data-toggle="modal" data-target="#modal-activation-'.$k->id_klien.'">Non-Active</button>';
                      }; ?>
                    </td>
                    <td>
                      <button type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#modal-edit-user-<?php echo $k->id_klien ?>">Edit</button> | 
                      <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modal-reset-user-<?php echo $k->id_klien ?>">Reset</button>
                    </td>
                  </tr>
                  <!-- modal edit klien -->
                  <div class="modal fade" id="modal-edit-user-<?php echo $k->id_klien ?>">
                      <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <?php echo form_open('core/client/edit'); ?>
                              <div class="card-body">
                                <input type="hidden" id="id_klien" name="id_klien" value="<?php echo $k->id_klien ?>">
                                <div class="form-group">
                                  <label for="exampleInputName">Name</label>
                                  <input type="text" value="<?php echo $k->nama_klien ?>" name="nama_klien" required class="form-control" id="exampleInputName" placeholder="Enter Name">
                                </div>
                                <div class="form-group">
                                  <label for="exampleInputEmail1">Email</label>
                                  <input type="email" value="<?php echo $k->email_klien ?>" required name="email_klien" class="form-control" id="exampleInputEmail1" placeholder="Enter Email">
                                </div>
                                <div class="form-group">
                                  <label for="exampleInputUsername">Username</label>
                                  <input type="text" value="<?php echo $k->username_klien ?>" name="username_klien" required class="form-control" id="exampleInputUsername" placeholder="Enter Username">
                                </div>
                                <div class="form-group">
                                  <label for="exampleInputPhone">Phone</label>
                                  <input type="number" value="<?php echo $k->telp_klien ?>" required name="telp_klien" class="form-control" id="exampleInputPhone" placeholder="Enter Phone Number">
                                </div>
                                <div class="form-group">
                                  <label>Department</label>
                                  <select class="form-control select2 select2-danger" data-dropdown-css-class="select2-danger" style="width: 100%;" name="id_dept" required>
                                    <option selected="selected" value="<?php echo $k->id_dept ?>"><?php echo $k->dept_name ?></option>
                                    <?php 
                                ...
                                <div class="form-group">
                                  ...
                                  <select class="form-control select2 select2-danger" data-dropdown-css-class="select2-danger" style="width: 100%;" name="id_loc" required>
                                    <option selected="selected" value="<?php echo $k->id_loc ?>"><?php echo $k->loc_name ?></option>
                                    <?php 
                  ...
                  <div class="modal fade" id="modal-reset-user-<?php echo $k->id_klien ?>">
                      <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h4 class="modal-title">Reset User Password <?php echo $k->nama_klien ?></h4>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                              <span aria-hidden="true">&times;</span>
                            </button>
                          </div>
                          <div class="modal-body">
                            <?php echo form_open('core/client/reset'); ?>
                              <div class="card-body">
                                <input type="hidden" id="id_klien" name="id_klien" value="<?php echo $k->id_klien ?>">
                                <input type="hidden" id="email_klien" name="email_klien" value="<?php echo $k->email_klien ?>">
                                <input type="hidden" id="nama_klien" name="nama_klien" value="<?php echo $k->nama_klien ?>">
                                <div class="form-group">
                                  <label for="exampleInputPassword">New Password</label>
                                  <input type="password" name="password_klien" required class="form-control" id="exampleInputPassword" placeholder="Enter New Password">
                                </div>
                              </div>
                    ...
                    <div class="modal fade" id="modal-activation-<?php echo $k->id_klien ?>">
                      <div class="modal-dialog">
                        <div class="modal-content bg-success">
                          <div class="modal-header">
                            <h4 class="modal-title">Aktifkan Klien?</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                              <span aria-hidden="true">&times;</span>
                            </button>
                          </div>
                          <div class="modal-body">
                            <p>Anda akan mengaktifkan klien <?php echo $k->nama_klien ?>?</p>
                          </div>
                          <?php echo form_open('core/client/activation'); ?>
                          <div class="modal-footer justify-content-between">
                            <input type="hidden" id="id_klien" name="id_klien" value="<?php echo $k->id_klien ?>">
                            <input type="hidden" id="status_klien" name="status_klien" value="1">
                    ...
                    <div class="modal fade" id="modal-nonactivation-<?php echo $k->id_klien ?>">
                      <div class="modal-dialog">
                        <div class="modal-content bg-danger">
                          <div class="modal-header">
                            <h4 class="modal-title">Non-Aktifkan Klien</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                              <span aria-hidden="true">&times;</span>
                            </button>
                          </div>
                          <div class="modal-body">
                            <p>Anda akan menon-aktifkan Klien <?php echo $k->nama_klien ?>?</p>
                          </div>
                          <?php echo form_open('core/client/activation'); ?>
                          <div class="modal-footer justify-content-between">
                            <input type="hidden" id="id_klien" name="id_klien" value="<?php echo $k->id_klien ?>">
                            <input type="hidden" id="status_klien" name="status_klien" value="2">
                            <button type="button" class="btn btn-outline-light" data-dismiss="modal">Close</button>
      ...
      <div class="modal fade" id="modal-create-new-user">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <?php echo form_open('core/client/add'); ?>
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputName">Name</label>
                    <input type="text" name="nama_klien" required class="form-control" id="exampleInputName" placeholder="Enter Name">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Email</label>
                    <input type="email" required name="email_klien" class="form-control" id="exampleInputEmail1" placeholder="Enter Email">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputUsername">Username</label>
                    <input type="text" name="username_klien" required class="form-control" id="exampleInputUsername" placeholder="Enter Username">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPhone">Phone</label>
                    <input type="number" required name="telp_klien" class="form-control" id="exampleInputPhone" placeholder="Enter Phone Number">
                  </div>
                  <div class="form-group">
                    <label>Department</label>
                    <select class="form-control select2 select2-danger" data-dropdown-css-class="select2-danger" style="width: 100%;" name="id_dept" required>
                  ...
                  <div class="form-group">
                    ...
                    <input type="password" name="password_klien" required class="form-control" id="exampleInputPassword1" placeholder="Password">
                  </div>
                </div>
