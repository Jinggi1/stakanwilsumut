...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <!-- END FLASH DATA -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"><button type="button" class="btn btn-block btn-primary btn-lg" data-toggle="modal" data-target="#modal-create-new-category">Create New</button></h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><?php echo $c->div_name ?></td>
                    <td>
                      <?php 
                      if ($c->cat_status == 1) {
                      echo '<button type="button" class="btn btn-block btn-success btn-sm" data-toggle="modal" data-target="#modal-nonactivation-'.$c->id_category.'">Active</button>';
                      }else{
                        echo '<button type="button" class="btn btn-block btn-danger btn-sm" data-toggle="modal" data-target="#modal-activation-'.$c->id_category.'">Non-Active</button>';
                      }; ?>
                    </td>
                    <td><button type="button" class="btn btn-block btn-warning btn-sm" data-toggle="modal" data-target="#modal-edit-category-<?php echo $c->id_category ?>">Edit</button></td>
                        <!-- modal edit user -->
                        <div class="modal fade" id="modal-edit-category-<?php echo $c->id_category ?>">
                          <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h4 class="modal-title">Edit Category <?php echo $c->category_name ?></h4>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                  <span aria-hidden="true">&times;</span>
                                </button>
                              </div>
                              <div class="modal-body">
                              <?php echo form_open('core/category/edit'); ?>
                                  <div class="card-body">
                                    <div class="form-group">
                                    <input type="hidden" id="id_category" name="id_category" value="<?php echo $c->id_category ?>">
                                      <label for="exampleInputName">Category Name</label>
                                      <input type="text" name="category_name" value="<?php echo $c->category_name ?>" class="form-control" id="exampleInputName" placeholder="Enter Location Name" required>
                                    </div>
                                    <div class="form-group">
                                      <label>Division</label>
                                      <select class="form-control select2 select2-danger" name="id_div" data-dropdown-css-class="select2-danger" style="width: 100%;" required>
                                        <option value="<?php echo $c->id_div ?>"><?php echo $c->div_name ?></option>
                                        <?php 
                        ...
                        <div class="modal fade" id="modal-activation-<?php echo $c->id_category ?>">
                          <div class="modal-dialog">
                            <div class="modal-content bg-success">
                              <div class="modal-header">
                                <h4 class="modal-title">Aktifkan Kategori?</h4>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                  <span aria-hidden="true">&times;</span>
                                </button>
                              </div>
                              <div class="modal-body">
                                <p>Anda akan mengaktifkan kategori <?php echo $c->category_name ?> ?</p>
                              </div>
                              <?php echo form_open('core/category/activation'); ?>
                              <div class="modal-footer justify-content-between">
                                <input type="hidden" id="id_category" name="id_category" value="<?php echo $c->id_category ?>">
                                <input type="hidden" id="cat_status" name="cat_status" value="1"> 
                        ...
                        <div class="modal fade" id="modal-nonactivation-<?php echo $c->id_category ?>">
                          <div class="modal-dialog">
                            <div class="modal-content bg-danger">
                              <div class="modal-header">
                                <h4 class="modal-title">Non-Aktifkan Kategori?</h4>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                  <span aria-hidden="true">&times;</span>
                                </button>
                              </div>
                              <div class="modal-body">
                                <p>Anda akan menon-aktifkan kategori <?php echo $c->category_name ?>?</p>
                              </div>
                              <?php echo form_open('core/category/activation'); ?>
                              <div class="modal-footer justify-content-between">
                                <input type="hidden" id="id_category" name="id_category" value="<?php echo $c->id_category ?>">
                                <input type="hidden" id="cat_status" name="cat_status" value="2"> 
                                <button type="button" class="btn btn-outline-light" data-dismiss="modal">Close</button>
      ...
      <!-- modal new user -->
      <div class="modal fade" id="modal-create-new-category">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
              <?php echo form_open('core/category/add'); ?>
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputName">Category Name</label>
                    <input type="text" name="category_name" class="form-control" id="exampleInputName" placeholder="Enter Category Name" required>
                  </div>
                  <div class="form-group">
                    <label>Division</label>
                    <select class="form-control select2 select2-danger" name="id_div" data-dropdown-css-class="select2-danger" style="width: 100%;" required>
