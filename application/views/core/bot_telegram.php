  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Pengaturan Bot Telegram</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-md-8">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <?php echo form_open('core/bot_telegram/edit'); ?>
                <div class="card-body">
                  <?php 
                  foreach($telegram_bot as $bot){ ?>
                  <input type="hidden" id="id_bot" name="id_bot" value="<?php echo $bot->id_bot ?>">
                  <div class="form-group">
                    <label for="bot_name">Bot Telegram Name</label>
                    <input type="text" name="bot_name" value="<?php echo $bot->bot_name; ?>" class="form-control" id="bot_name" placeholder="Enter Bot Name" required>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputSmtpHost1">Bot Token</label>
                    <input type="text" name="bot_token" value="<?php echo $bot->bot_token; ?>" class="form-control" id="exampleInputSmtpHost1" placeholder="Bot Token" required>
                  </div>
                </div>
                <?php } ?>
                <!-- /.card-body -->
